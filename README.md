...
- This repository also includes the renderer (Open-Attestation) for converting Verifiable Credentials into visually appealing, human-readable, and, if needed, regulatory-compliant templates.

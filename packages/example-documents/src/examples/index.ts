import BankAccountCredential from './BankAccountCredential.json' assert { type: 'json' };
import BillOfLadingCredential from './BillOfLadingCredential.json' assert { type: 'json' };
import CBP3461ImmediateDeliveryCredential from './CBP3461ImmediateDeliveryCredential.json' assert { type: 'json' };
import CBP7501EntrySummaryCredential from './CBP7501EntrySummaryCredential.json' assert { type: 'json' };
import CTPATCertificate from './CTPATCertificate.json' assert { type: 'json' };
import CTPATEIPApplicationCredential from './CTPATEIPApplicationCredential.json' assert { type: 'json' };
import CTPATEIPFulfillmentCredential from './CTPATEIPFulfillmentCredential.json' assert { type: 'json' };
import CTPATEIPMarketplaceCredential from './CTPATEIPMarketplaceCredential.json' assert { type: 'json' };
import CTPATEIPSellerCredential from './CTPATEIPSellerCredential.json' assert { type: 'json' };
import CertificationOfOrigin from './CertificationOfOrigin.json' assert { type: 'json' };
import CommercialInvoiceCredential from './CommercialInvoiceCredential.json' assert { type: 'json' };
import CrudeOilProductCredential from './CrudeOilProductCredential.json' assert { type: 'json' };
import DCSAShippingInstructionCredential from './DCSAShippingInstructionCredential.json' assert { type: 'json' };
import DCSATransportDocumentCredential from './DCSATransportDocumentCredential.json' assert { type: 'json' };
import DeMinimisShipmentCredential from './DeMinimisShipmentCredential.json' assert { type: 'json' };
import EventCredential from './EventCredential.json' assert { type: 'json' };
import FSMACreatingCTECredential from './FSMACreatingCTECredential.json' assert { type: 'json' };
import FSMAFirstReceiverDataCredential from './FSMAFirstReceiverDataCredential.json' assert { type: 'json' };
import FSMAGrowingCTECredential from './FSMAGrowingCTECredential.json' assert { type: 'json' };
import FSMAReceivingCTECredential from './FSMAReceivingCTECredential.json' assert { type: 'json' };
import FSMAShippingCTECredential from './FSMAShippingCTECredential.json' assert { type: 'json' };
import FSMATransformingCTECredential from './FSMATransformingCTECredential.json' assert { type: 'json' };
import FoodDefenseInspectionCredential from './FoodDefenseInspectionCredential.json' assert { type: 'json' };
import FoodGradeInspectionCredential from './FoodGradeInspectionCredential.json' assert { type: 'json' };
import FreightManifestCredential from './FreightManifestCredential.json' assert { type: 'json' };
import FulfillmentRegistrationCredential from './FulfillmentRegistrationCredential.json' assert { type: 'json' };
import GAPInspectionCredential from './GAPInspectionCredential.json' assert { type: 'json' };
import GS18PrefixLicenseCredential from './GS18PrefixLicenseCredential.json' assert { type: 'json' };
import GS1CompanyPrefixLicenseCredential from './GS1CompanyPrefixLicenseCredential.json' assert { type: 'json' };
import GS1DataCredential from './GS1DataCredential.json' assert { type: 'json' };
import GS1DelegationCredential from './GS1DelegationCredential.json' assert { type: 'json' };
import GS1IdentificationKeyLicenseCredential from './GS1IdentificationKeyLicenseCredential.json' assert { type: 'json' };
import GS1KeyCredential from './GS1KeyCredential.json' assert { type: 'json' };
import GS1PrefixLicenseCredential from './GS1PrefixLicenseCredential.json' assert { type: 'json' };
import HouseBillOfLadingCredential from './HouseBillOfLadingCredential.json' assert { type: 'json' };
import IATAAirWaybillCredential from './IATAAirWaybillCredential.json' assert { type: 'json' };
import ImporterSecurityFilingCredential from './ImporterSecurityFilingCredential.json' assert { type: 'json' };
import IntellectualPropertyRightsCredential from './IntellectualPropertyRightsCredential.json' assert { type: 'json' };
import IntentToImportCredential from './IntentToImportCredential.json' assert { type: 'json' };
import InventoryRegistrationCredential from './InventoryRegistrationCredential.json' assert { type: 'json' };
import MasterBillOfLadingCredential from './MasterBillOfLadingCredential.json' assert { type: 'json' };
import MillTestReportCredential from './MillTestReportCredential.json' assert { type: 'json' };
import MultiModalBillOfLadingCredential from './MultiModalBillOfLadingCredential.json' assert { type: 'json' };
import NaturalGasProductCredential from './NaturalGasProductCredential.json' assert { type: 'json' };
import OrderConfirmationCredential from './OrderConfirmationCredential.json' assert { type: 'json' };
import OrganicCertificateCredential from './OrganicCertificateCredential.json' assert { type: 'json' };
import PGAShipmentStatusCredential from './PGAShipmentStatusCredential.json' assert { type: 'json' };
import PackingListCredential from './PackingListCredential.json' assert { type: 'json' };
import PlantSystemsInspectionCredential from './PlantSystemsInspectionCredential.json' assert { type: 'json' };
import ProductRegistrationCredential from './ProductRegistrationCredential.json' assert { type: 'json' };
import ProformaInvoiceCredential from './ProformaInvoiceCredential.json' assert { type: 'json' };
import PurchaseOrderCredential from './PurchaseOrderCredential.json' assert { type: 'json' };
import SIMASteelImportLicenseApplicationCredential from './SIMASteelImportLicenseApplicationCredential.json' assert { type: 'json' };
import SIMASteelImportLicenseCredential from './SIMASteelImportLicenseCredential.json' assert { type: 'json' };
import SeaCargoManifestCredential from './SeaCargoManifestCredential.json' assert { type: 'json' };

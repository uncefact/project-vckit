import { IAgentPlugin, IPluginMethodMap, IAgentPluginSchema } from '@vckit/core-types'

/**
 * This plugin can be used to access the methods of a remote Veramo agent as if they were implemented locally.
 *
 * The remote agent should be provided by {@link @vckit/remote-server#AgentRouter | AgentRouter}, or a similar
 * implementation of this API.
 *
 * The schema of the remote agent is usually provided by {@link @vckit/remote-server#ApiSchemaRouter |
 * ApiSchemaRouter}.
 *
 * @public
 */

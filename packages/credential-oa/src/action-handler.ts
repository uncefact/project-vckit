...
/**
 * A Veramo plugin that implements the {@link @vckit/core-types#ICredentialPlugin | ICredentialPlugin} methods.
 *
 * @public
 */
export class CredentialPlugin implements IAgentPlugin {
  readonly methods: IOpenAttestationPlugin
  readonly schema = {
    components: {
      schemas: {
      ...
      methods: {
        ...schema.ICredentialIssuer.components.methods.createVerifiableCredential,
        ...schema.ICredentialVerifier.components.methods.verifyCredential,
      },
    },
  }
  ...
  /** {@inheritdoc @vckit/core-types#ICredentialIssuer.createVerifiablePresentation} */
  ...
  /** {@inheritdoc @vckit/core-types#ICredentialIssuer.createVerifiableCredential} */
  ...
  /** {@inheritdoc @vckit/core-types#ICredentialVerifier.verifyCredential} */
  ...
  /** {@inheritdoc @vckit/core-types#ICredentialVerifier.verifyPresentation} */

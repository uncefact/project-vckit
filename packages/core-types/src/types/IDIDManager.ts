...
export interface IDIDManager extends IPluginMethodMap {
   ...
   *   {@link @uncefact/vckit-core-types#IKeyManager} methods.
   *
   * @example
   * ```typescript
   ...
   *   that has {@link @uncefact/vckit-core-types#IKeyManager} methods
   *
   * @example
   * ```typescript
   * const identifier = await agent.didManagerCreate()
  ...
  /**
   * Updates the DID document of a managed {@link @uncefact/vckit-core-types#IIdentifier | DID}.

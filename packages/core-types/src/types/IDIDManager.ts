...
export interface IDIDManager extends IPluginMethodMap {
   ...
   *   {@link @vckit/core-types#IKeyManager} methods.
   *
   * @example
   * ```typescript
   ...
   *   that has {@link @vckit/core-types#IKeyManager} methods
   *
   * @example
   * ```typescript
   * const identifier = await agent.didManagerCreate()
  ...
  /**
   * Updates the DID document of a managed {@link @vckit/core-types#IIdentifier | DID}.

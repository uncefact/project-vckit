...
export interface ICreateVerifiableCredentialArgs {
   ...
   *   {@link @vckit/core-types#IDataStore.dataStoreSaveVerifiableCredential | dataStoreSaveVerifiableCredential()} to save
 ...
 * @public
 */
export interface ICredentialIssuerBase extends IPluginMethodMap {
  /**
   ...
   *
   * @returns - a promise that resolves to the {@link @vckit/core-types#VerifiableCredential} that was requested or rejects
...
export type IssuerAgentContext = IAgentContext<
  IResolver &
    ...
    Pick<IDataStore,  'dataStoreSaveVerifiableCredential'> &

...
export interface IHandleMessageArgs {
   ...
   * {@link @uncefact/vckit-core-types#IDataStore.dataStoreSaveMessage | dataStoreSaveMessage}
   * <p/><p/>
   * @deprecated Please call {@link @uncefact/vckit-core-types#IDataStore.dataStoreSaveMessage | dataStoreSaveMessage()} after
...
export interface IMessageHandler extends IPluginMethodMap {
   ...
   * {@link @uncefact/vckit-core-types#IDataStore.dataStoreSaveMessage | dataStoreSaveMessage()} to save it.
   *

 ...
 * {@link @uncefact/vckit-core-types#VerifiableCredential | Verifiable Credential}.
 *
...
export interface ICredentialStatusVerifier extends IPluginMethodMap {
  /**
   * Checks the status of a {@link @uncefact/vckit-core-types#VerifiableCredential | Verifiable Credential}.
   *
